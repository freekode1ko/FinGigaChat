...
reg_mail_text = (
    'Привет!\n\nВ конце письма будет написаны уникальные коды необходимые для подтверждения регистрации, '
    'один любой из них надо ввести в Бота.\n'
    'Эти коды никому нельзя показывать!\n\n\n{}\n{}'
)
