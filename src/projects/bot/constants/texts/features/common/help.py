...
class HelpTexts(BaseSettings):
    ...
    HELP_TEXT: str = Field(
        (
            ...
            'в отрасли, у компании в сжатом виде.\n\n'

            'На данный момент в AI-помощнике доступен следующий функционал и контент:\n\n'

            '—> Новости по отраслям, компаниям, commodities из более чем 1000 источников, включая ключевые финансовые и '
            ...
            '—> Навигация по информации о компаниях;\n'
