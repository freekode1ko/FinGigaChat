...
Revision ID: ebcdffb148b3
Revises: 3121e35c7891
Create Date: 2024-09-27 12:50:28.652552
...
def upgrade() -> None:
    ...
    op.create_table('quotes_section',
    ...
    op.create_table('users_quotes_subscriptions',
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
