...
giga_model = 'GigaChat-Pro'  # FIXME: переименовать
giga_model_max = 'GigaChat-Max'
...
INDUSTRY_EXPERTISE = (
    'https://upd.mobile.sbrf.ru:10443/ios/dl/gdash/1000000251/1000004881'
    '#ewogICJ3aWRnZXRzIiA6IHsKICAgICIxMDAwMDQxMDg3IiA6IHsKCiAgICB9LAogICAgIjEwMDAwNDEwODgiIDogewoKICAgIH0sCiAgICAiMTAwM'
    'DA0MTA5MCIgOiB7CgogICAgfSwKICAgICIxMDAwMDQxMDg5IiA6IHsKCiAgICB9CiAgfQp9'
)
