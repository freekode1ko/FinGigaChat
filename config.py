...
api_token = '6747701950:AAFEu1h8JZzDta7UZPScWs5mGm0s2OZLDMc'  # LOCAL

psql_engine = 'postgresql://bot:12345@217.18.62.123:5432/users'
...
help_text = (
    ...
    'Также вы можете задавать любые вопросы теоретического характера без привязки к актуальным данным, например: '
    ...
    'в боковом меню нажать «Меню подписок» и следовать инструкции. На данный момент доступны следующие отрасли: '
