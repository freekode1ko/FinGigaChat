...
from models.models import RegisteredUser, UserRole, Feature
...
def create_objs(
        ...
        model: Type[Feature | UserRole],
        data: dict[str, str]
) -> list[Feature | UserRole]:
    """
...
def create_relations(session: sa.orm.Session, features: list[Feature], roles: list[UserRole]) -> None:
    """
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('user_role_id', 'feature_id'),
    ...
    features = create_objs(session, Feature, BOT_FEATURES_DATA)
