...
# from configs import config # FIXME
...
PRODUCTS_DATA_ROOT_ABS_PATH = PATH_TO_SOURCES / 'products' / 'product_shelf' # FIXME
HOT_OFFERS_DATA_ROOT_ABS_PATH = PATH_TO_SOURCES / 'products' / 'hot_offers' # FIXME
PRODUCTS_DATA_PATH = Path('sources') / 'products' / 'product_shelf' # FIXME
HOT_OFFERS_DATA_PATH = Path('sources') / 'products' / 'hot_offers' # FIXME
