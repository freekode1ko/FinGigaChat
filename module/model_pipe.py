...
CLIENT_BINARY_CLASSIFICATION_MODEL_PATH = 'model/client_relevance_model_0.54_threshold.pkl'
...
def rate_client(df, rating_dict, threshold: float = 0.54) -> pd.DataFrame:
    """
