...
from utils.quotes.loader import load_cbr_metals, load_cbr_quotes, load_moex_quotes, load_yahoo_quotes, load_gigaparser_quotes
...
async def update_quote_data():
    ...
    for func in (load_gigaparser_quotes,):
        for _ in range(5):
            try:
                await func()
            except Exception:
