...
list_of_companies = [
    ['831', 'Полиметалл', 'https://www.polymetalinternational.com/ru/investors-and-media/reports-and-results/result-centre/'],
...
dict_of_commodities = {
    'Нефть Brent, $/бар': {'links': ['CO1'], 'to_take': 4, 'measurables': '$/бар', 'naming': 'Brent', 'alias': 'Нефть'},
    'Нефть WTI, $/бар': {
        'links': ['8849', 'https://ru.investing.com/commodities/crude-oil'],
        'to_take': 1,
        'measurables': '$/бар',
        'naming': 'WTI',
        'alias': 'Нефть',
    ...
    'Нефть Urals, $/бар': {
        'links': ['1168084', 'https://www.investing.com/commodities/crude-oil-urals-spot-futures'],
        'to_take': 1,
        'measurables': '$/бар',
        'naming': 'Urals',
        'alias': 'Нефть',
    ...
    'Золото спот, $/унц': {'links': ['XAU'], 'to_take': 4, 'measurables': '$/унц', 'naming': 'Gold spot', 'alias': 'золото'},
    'Медь LME спот, $/т': {
        'links': ['LMCADY'],
        'to_take': 4,
        'measurables': '$/т',
    ...
    'Никель LME спот, $/т': {'links': ['LMNIDY'], 'to_take': 4, 'measurables': '$/т', 'naming': 'Nickel LME spot', 'alias': 'никель'},
    ...
    'Цинк LME спот, $/т': {'links': ['LMZSDY'], 'to_take': 4, 'measurables': '$/т', 'naming': 'Zinc LME spot', 'alias': 'цинк'},
    'Свинец LME спот, $/т': {'links': ['LMPBDY'], 'to_take': 4, 'measurables': '$/т', 'naming': 'Lead LME spot', 'alias': 'свинец'},
    'Серебро спот, $/унц': {'links': ['SILV'], 'to_take': 4, 'measurables': '$/унц', 'naming': 'Silver spot', 'alias': 'серебро'},
    'Кобальт LME спот, $/т': {
        'links': ['LMCODY'],
        'to_take': 4,
        'measurables': '$/т',
    ...
    'Олово LME spot, $/т': {'links': ['LMSNDY'], 'to_take': 4, 'measurables': '$/т', 'naming': 'Tin LME spot', 'alias': 'олово'},
    ...
    'Лом РФ, $/т': {'links': ['RUSCRAP2'], 'to_take': 3, 'measurables': '$/т', 'naming': 'Scrap Russia domestic', 'alias': 'Сталь'},
...
dict_of_companies = {
    'Газпром': {'company_id': '656', 'alias': 'Нефть и газ'},
    'Газпром нефть': {'company_id': '657', 'alias': 'Нефть и газ'},
    'ЛУКойл': {'company_id': '673', 'alias': 'Нефть и газ'},
    'НОВАТЭК': {'company_id': '690', 'alias': 'Нефть и газ'},
    'Роснефть': {'company_id': '710', 'alias': 'Нефть и газ'},
    'Татнефть': {'company_id': '722', 'alias': 'Нефть и газ'},
    'Транснефть': {'company_id': '734', 'alias': 'Нефть и газ'},
    'Полиметалл': {'company_id': '831', 'alias': 'Металлургия'},
    'ММК': {'company_id': '675', 'alias': 'Металлургия'},
    'НЛМК': {'company_id': '691', 'alias': 'Металлургия'},
    'Норильский Никель': {'company_id': '689', 'alias': 'Металлургия'},
    'Полюс': {'company_id': '827', 'alias': 'Металлургия'},
    'РУСАЛ': {'company_id': '798', 'alias': 'Металлургия'},
    'Северсталь': {'company_id': '714', 'alias': 'Металлургия'},
    'Акрон': {'company_id': '640', 'alias': 'Химическая промышленность'},
    'ФосАгро': {'company_id': '824', 'alias': 'Химическая промышленность'},
    'TCS Group': {'company_id': '846', 'alias': 'Финансовый сектор'},
    'Банк Санкт-Петербург': {'company_id': '750', 'alias': 'Финансовый сектор'},
    'ВТБ': {'company_id': '744', 'alias': 'Финансовый сектор'},
    'Московская биржа': {'company_id': '872', 'alias': 'Финансовый сектор'},
    'Интер РАО': {'company_id': '781', 'alias': 'Электроэнергетика'},
    'Мосэнерго': {'company_id': '682', 'alias': 'Электроэнергетика'},
    'ОГК-2': {'company_id': '694', 'alias': 'Электроэнергетика'},
    'РусГидро': {'company_id': '749', 'alias': 'Электроэнергетика'},
    'ТГК-1': {'company_id': '723', 'alias': 'Электроэнергетика'},
    'ЭЛ5 Энерго': {'company_id': '696', 'alias': 'Электроэнергетика'},
    'Юнипро': {'company_id': '695', 'alias': 'Электроэнергетика'},
    'Fix Price Group': {'company_id': '1437', 'alias': 'Потребительский сектор'},
    'X5 Retail Group': {'company_id': '747', 'alias': 'Потребительский сектор'},
    'Детский мир': {'company_id': '1404', 'alias': 'Потребительский сектор'},
    'Лента': {'company_id': '1296', 'alias': 'Потребительский сектор'},
    'М.Видео': {'company_id': '796', 'alias': 'Потребительский сектор'},
    'Магнит': {'company_id': '674', 'alias': 'Потребительский сектор'},
    'ОКЕЙ': {'company_id': '817', 'alias': 'Потребительский сектор'},
    'Русагро': {'company_id': '832', 'alias': 'Потребительский сектор'},
    'Эталон': {'company_id': '835', 'alias': 'Недвижимость'},
    'ГК ПИК': {'company_id': '701', 'alias': 'Недвижимость'},
    'ГК Самолет': {'company_id': '1441', 'alias': 'Недвижимость'},
    'ЛСР': {'company_id': '778', 'alias': 'Недвижимость'},
    'ХэдХантер': {'company_id': '1416', 'alias': 'Интернет'},
    'Ozon': {'company_id': '1430', 'alias': 'Интернет'},
    'VK': {'company_id': '819', 'alias': 'Интернет'},
    'Whoosh': {'company_id': '1443', 'alias': 'Интернет'},
    'Группа Позитив': {'company_id': '1440', 'alias': 'Интернет'},
    'Яндекс': {'company_id': '821', 'alias': 'Интернет'},
    'АФК Система': {'company_id': '718', 'alias': 'Телекоммуникации'},
    'МТС': {'company_id': '686', 'alias': 'Телекоммуникации'},
    'Ростелеком': {'company_id': '871', 'alias': 'Телекоммуникации'},
    'Аэрофлот': {'company_id': '641', 'alias': 'Транспорт'},
    'Глобалтранс': {'company_id': '771', 'alias': 'Транспорт'},
    'Совкомфлот': {'company_id': '873', 'alias': 'Транспорт'},
    'Сегежа': {'company_id': '1438', 'alias': 'Промышленность'},
}
