...
class StakeholderTexts(BaseSettings):
    ...
    BEN_MENU_NEWS: str = 'Выберите наименования, по которым хотите получить новости'
    LPR_MENU_NEWS: str = 'Выберите наименования, по которым хотите получить новости'
    COMMON_MENU_NEWS: str = 'Выберите наименования, по которым хотите получить новости'
