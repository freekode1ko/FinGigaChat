...
data = [
    ...
    {"name": "Отчеты CIB Research", "period_cron": RESEARCH_CRON_TO_PARSE, "alert_timedelta": 60*60*24*14},
    ...
    {"name": "Отраслевые новости (тг)", "period_cron": "*/20 9-17 * * *", "alert_timedelta": 60*60*3},
    {"name": "Новости по сущностям", "period_cron": "*/20 9-17 * * *", "alert_timedelta": 60*60*2},
  ]
