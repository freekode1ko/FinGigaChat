...
class RAGRouter:
    ...
    def rag_qa_banker(self) -> str:
        ...
        try:
            ...
            if rag_response.status_code == 200:
                ...
                if re.search('нефть', self.query):
                    response = ('ОПЕК прогнозирует рост спроса на нефть в 2024 году. '
                                'Согласно прогнозам, глобальный спрос на нефть в 2024 году составит 104,46 млн б/с, '
                                'а в 2025 году - 106,3 млн б/с. <a href="https://t.me/oil_capital/17678">t.me/oil_capital</a>'
                                )
    ...
    def rag_state_support(self) -> str:
        ...
        if re.search('1570', self.query):
            return ('Льготная процентная ставка по кредиту составляет 3 процента годовых для технологических компаний и'
                    ' 5 процентов годовых для иных заемщиков.')

        elif re.search('295', self.query):
            return (' Постановление Правительства РФ от 22.02.2023 № 295 "О государственной поддержке организаций, '
                    'реализующих инвестиционные проекты, направленные на производство приоритетной продукции"'
                    ' устанавливает правила предоставления субсидий из федерального бюджета российским кредитным '
                    'организациям и государственной корпорации развития "ВЭБ.РФ" на возмещение недополученных ими '
                    'доходов по кредитам, предоставленным российским организациям промышленности на цели реализации '
                    'инвестиционных проектов, направленных на производство приоритетной продукции, по льготной '
                    'процентной ставке.')
