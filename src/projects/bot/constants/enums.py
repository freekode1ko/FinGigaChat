...
class RAGCategoryGroup(Enum):
    """Группы RAG категорий."""

    currency_market_analytics = ('аналитика валютного рынка', )
    industry_analytics = ('аналитика отрасли', 'регулирование в отрасли', 'аналитика по товару')
    clients = ('аналитика по компании', 'новости о компании', 'финансовые показатели по компании', 'дивиденды по компании')
    unemployment = ('безработица', )
    inner_info = ('внутренняя информация', 'регулирование банковской отрасли', 'продукты банка')
    investment = ('инвестирование', 'рынок акций')
    inflation = ('инфляция в мире', 'инфляция в россии')
    mortgage = ('ипотека', )
    world_cb_rates = ('ключевая ставка в мире', )
    current_rate = ('ключевая ставка цб рф', )
    exchange_rates = ('курсы валют', )
    macro_analytics = ('макроаналитика', 'макропрогноз', 'новости по макроэкономике', 'санкции')
    macro_e_countries = ('макроэкономика других стран', )
    taxes = ('налоги', )
    bond_market = ('рынок облигаций', )
    commodity_price = ('стоимость товара', )
    stock_market = ('фондовый рынок - аналитика', )
    etc = ('ценообразование кредитных продуктов', )
