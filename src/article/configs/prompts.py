"""Промты для суммаризации и фильтрации"""
...
CLIENT_MESSAGE_PROMPT = (
    ...
    'данная новость: {} и заверши свой ответ оценкой <?> без других лишних символов после'
)
...
COMMODITY_SYSTEM_PROMPT = (
    ...
    '<1> или <0> без других лишних символов, означающее относится ли новость к товару, или нет. '
...
COMMODITY_MESSAGE_PROMPT = (
    'Определи, относится ли к товару {} данная новость: {} и заверши свой ответ оценкой <?> без других лишних '
    'символов после'
)
