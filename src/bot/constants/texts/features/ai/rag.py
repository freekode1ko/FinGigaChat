...
class RAGTexts(BaseSettings):
    ...
    RAG_ERROR_ANSWER = 'Извините, я пока не могу ответить на ваш запрос.'

    RAG_LIKE_FEEDBACK = 'Я рад, что вам понравилось!'
    RAG_DISLIKE_FEEDBACK = 'Я буду стараться лучше...'
